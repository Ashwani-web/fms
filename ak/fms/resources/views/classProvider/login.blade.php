...
<div class="container">
    <div class="row">
    <section class="registration col-lg-12">
		<div class="container">
			<div class="row" style="margin-top: 80px;">
				...
				<div class="col-lg-5">
					<div class="fms-form">
						<h2>Log In...&#41;</h2>
						<p> Class Provider Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>

                        <form class="form-horizontal" method="POST" action="{{ url('classprovider/login') }}">
                        {{ csrf_field() }}
