			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					@foreach($getallClassProviders as $classprovidername)
						<div class="col-md-12">
							<div class="classview">
								<img src="{{ url('/image/classview.jpg') }}" alt="">
								<div class="classtext">
									<h4>{{$classprovidername->name}}</h4>
									<p>Category: <span>{{$classprovidername->category_name}}<a href="/view/{id}">more</a></p>
									<p>Sub-category: <span>{{$classprovidername->subcatgory_name}}</span> <a href="#">more</a></p>
									...
									<a  href="/view/{{$id}}"> MORE INFO &amp; BOOKINGS</a>
